...
import 'package:hungry_app/features/check_out/widget/order_details_widget.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Gap(10),
              OrderDetailsWidget(
                order: widget.totalPrice ?? "18.8",
                taxes: "3.5",
                fees: "2.4",
                total: (double.parse(widget.totalPrice) + 3.50 + 2.40)
                    .toStringAsFixed(2),
              ),
              Gap(80),
              CustomText(
              ...
              /// Visa
              authRepo.currentUser?.visa == null
                  ? SizedBox(
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  CustomText(
                    text:
                        '\$ ${(double.parse(widget.totalPrice) + 3.50 + 2.40).toStringAsFixed(2)}',
                    size: 20,
                  ),
                ],
              ),
